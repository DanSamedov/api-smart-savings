...
async def create_gdpr_pdf(data: Dict, password: str) -> bytes:
    ...
    metadata_data = [
        [
            Paragraph("Generated At:", cell_header_style),
            Paragraph(data["export_metadata"]["generated_at"], cell_style),
        ]
    ]
    ...
    profile_data = [
        [
            Paragraph("User ID:", cell_header_style),
            Paragraph(profile["user_id"], cell_style),
        ],
        [
            Paragraph("Email:", cell_header_style),
            Paragraph(profile["email"], cell_style),
        ],
        [
            Paragraph("Full Name:", cell_header_style),
            Paragraph(profile["full_name"], cell_style),
        ],
        [Paragraph("Role:", cell_header_style), Paragraph(profile["role"], cell_style)],
        [
            Paragraph("Preferred Currency:", cell_header_style),
            Paragraph(profile["preferred_currency"], cell_style),
        ],
        [
            Paragraph("Preferred Language:", cell_header_style),
            Paragraph(profile["preferred_language"], cell_style),
        ],
        [
            Paragraph("Account Verified:", cell_header_style),
            Paragraph("Yes" if profile["is_verified"] else "No", cell_style),
        ],
        [
            Paragraph("Account Enabled:", cell_header_style),
            Paragraph("Yes" if profile["is_enabled"] else "No", cell_style),
        ],
        [
            Paragraph("Account Deleted:", cell_header_style),
            Paragraph("Yes" if profile["is_deleted"] else "No", cell_style),
        ],
        [
            Paragraph("Created At:", cell_header_style),
            Paragraph(profile["created_at"], cell_style),
        ],
        [
            Paragraph("Updated At:", cell_header_style),
            Paragraph(profile["updated_at"], cell_style),
        ],
    ]
    ...
    auth_data = [
        [
            Paragraph("Last Login:", cell_header_style),
            Paragraph(auth["last_login_at"], cell_style),
        ],
        [
            Paragraph("Failed Login Attempts:", cell_header_style),
            Paragraph(str(auth["failed_login_attempts"]), cell_style),
        ],
        [
            Paragraph("Last Failed Login:", cell_header_style),
            Paragraph(auth["last_failed_login_at"], cell_style),
        ],
    ]
    ...
    wallet_data = [
        [
            Paragraph("Wallet ID:", cell_header_style),
            Paragraph(wallet["wallet_id"], cell_style),
        ],
        [
            Paragraph("Total Balance:", cell_header_style),
            Paragraph(wallet["total_balance"], cell_style),
        ],
        [
            Paragraph("Locked Amount:", cell_header_style),
            Paragraph(wallet["locked_amount"], cell_style),
        ],
        [
            Paragraph("Available Balance:", cell_header_style),
            Paragraph(wallet["available_balance"], cell_style),
        ],
        [
            Paragraph("Created At:", cell_header_style),
            Paragraph(wallet["created_at"], cell_style),
        ],
    ]
    ...
    if data["transactions"]:
        ...
        trans_table = Table(
            trans_data,
            colWidths=[1.2 * inch, 1.5 * inch, 0.8 * inch, 1 * inch, 1.5 * inch],
        )
        ...
        if len(data["transactions"]) > 50:
            ...
            elements.append(
                Paragraph(
                    f"<i>Showing 50 of {len(data['transactions'])} transactions</i>",
                    styles["Normal"],
                )
            )
    else:
    ...
    if data["gdpr_requests"]:
        ...
        gdpr_table = Table(
            gdpr_data, colWidths=[1.5 * inch, 1.5 * inch, 1.5 * inch, 1.5 * inch]
        )
        gdpr_table.setStyle(
            TableStyle(
                [
    ...
    if data.get("ims_actions"):
        ...
        elements.append(
            Paragraph("No SaveBuddy AI interactions found.", styles["Normal"])
        )
