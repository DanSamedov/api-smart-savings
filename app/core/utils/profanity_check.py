...
EN_PROFANITY = {
    ...
    "pussy", "cunt", "whore", "slut", "porn", "sex", "nude",
    "faggot", "nigger", "retard", "penis"
}
# Spanish profanity
ES_PROFANITY = {
    "puta", "puto", "mierda", "joder", "coño", "polla",
    "verga", "culo", "zorra", "maricon", "porno", "pene"
}
# Polish profanity
PL_PROFANITY = {
    "kurwa", "chuj", "pizda", "jebac", "jebany", "dupa",
    "cipa", "pierdol", "porno", "pizda", "pizde", "pizdej",
    "pizdem", "pizdemu", "pizdemy"
}
