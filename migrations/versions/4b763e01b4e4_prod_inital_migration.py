...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "total_balance", sa.Numeric(15, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "locked_amount", sa.Numeric(15, 4), nullable=False, server_default="0"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "require_admin_approval_for_funds_removal",
            sa.Boolean(),
            nullable=False,
            server_default=sa.text("false"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "contributed_amount", sa.Numeric(10, 2), nullable=False, server_default="0"
        ),
        sa.Column(
            "joined_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PROCESSING", "COMPLETED", "REFUSED", name="gdpr_request_status_enum"
            ),
            nullable=False,
